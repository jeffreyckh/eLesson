...
<body>
  <div class = "col-md-7">
    ...
    <div class = "row">
      <div class = "col-md-2">
        <figure>
        <a id="course" href="courses.php"><img src="../img/blackboard.png"></a>
        <figcaption>Course</figcaption>
        </figure>
      </div>
      <div class = "col-md-2">
        <figure>
        <a id="account" href="add_announcement.php"><img src="../img/announcement.png"></a>
      ...
      <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
        <div class="panel-body">
            <fieldset class = "setright">
              <?php
                  $query="select * from announcement order by taskdate DESC limit 1";
